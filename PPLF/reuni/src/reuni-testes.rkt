...
(define (check-encontrar-dispo-em-comum dispo-a dispo-b esperado)
  ; não importa a ordem dos parâmetros, a interseção é a mesma
  (check-equal? (encontrar-dispo-em-comum dispo-a dispo-b (horario 00 00)) esperado)
  (check-equal? (encontrar-dispo-em-comum dispo-b dispo-a (horario 00 00)) esperado))
